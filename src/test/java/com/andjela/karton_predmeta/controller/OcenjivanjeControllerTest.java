...
public class OcenjivanjeControllerTest {
    
    @Mock
    private OcenjivanjeService service;

    @InjectMocks
    private OcenjivanjeController controller;

    @Test
    void create_vracaCreatedStatus() {

        CreateOcenjivanjeDto dto = new CreateOcenjivanjeDto();
